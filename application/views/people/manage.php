...
<div class="table-content-menu">
    <div id="menu-table-data">
        <div class="menu-table-data" id="create-new-customer">
            ...
            array('class'=>'thickbox none new','id'=>'icon-create-new-customer', 'title'=>lang($controller_name.'_new')));
            ?>
        </div>
        <div class="menu-table-data" id="send-mail">
            ...
            <div class="menu-table-data" id="excel-import">
        ...
        <div class="menu-table-data" id="excel-export">
            <?php
        ...
        <div class="menu-table-data" id="delete-customers">
            <?php echo anchor("$controller_name/delete",lang("common_delete"),array('id'=>'delete', 'class'=>'delete_inactive')); ?>
        </div>

        <?php if ($controller_name =='customers') {?>
        <div class="menu-table-data" id="cleanup-old-customers">
            <?php echo
